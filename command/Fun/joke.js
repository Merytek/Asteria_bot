...
module.exports.run = (Root, message, args) => {
    const jokeList = [
        ...
        "un jour en 1786 une fille a fait passé une chain mail avec écrit je suis chuck norris. Chuck norris a reçu le mail la fille en question est devenue aveugle et il a fallut plus de 2 siècles pour pouvoir réparer internet",
